...
class transport:
    def __init__(self, type:str, fromLocation:str, toLocation:str, cost:int, booked:bool, link):
        self.type = type
...
class trip:
    def __init__(self, tripName:str, dest:dest, hotels:hotels, activities:activities, transportations:transportations, totalCost:int):
